"""Regression checks for the swiftgit casebook."""
...
from casebook.harness import assert_expected, swiftgit_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(swiftgit_summary(), assert_expected())
