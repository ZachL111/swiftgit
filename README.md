...
swiftgit is a Swift project for developer tools. It focuses on this technical goal: Read loose Git object headers and summarize object kinds.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 167, risk penalty 7, latency penalty 2, and weight bonus 5. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
